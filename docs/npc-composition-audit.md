...
5. **Item customization is partial.** Reusable masterwork and +1–+5 enhancement lenses now derive weapon, armor, and shield effects and pricing from base items. Special properties and charges remain explicit `npc.item-customization-unimplemented` gaps.
