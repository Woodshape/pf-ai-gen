...
- Worg, Griffon, Medusa, Goblin Druid, Fighter, Sorcerer, Clockwork, Skeleton, Lycanthrope, Metadaten-/Metamagie, das CR-9-Aberrant-Beispiel, Draft-/Proposal-/FinishedMonster-Persistenz, Exporte und Browser-Transport sind in 134 öffentlichen Python-Tests plus fünf Node-Adapter-Checks abgesichert. Die Matrix deckt alle 93 Step-1-Zeilen, jedes Attack-Profil, alle 231 Zellen von Table 5-9, alle 162 Options auf einem gültigen Pfad, harte Prärequisiten, typisierte Skalierungsgrenzen, alle Size-Grenzen und beide Seiten aller Spell-Bänder ab; JSONL läuft über `python -m monster_builder`.
