...
SOURCE_FILES = (
    ...
    ("source.aon-hobgoblin-race", "sources/npc/aonprd/hobgoblin-race.txt", "Official AoN standard Hobgoblin racial traits"),
    ("source.aon-rogue-talent-bleeding-attack", "sources/npc/aonprd/rogue-talent-bleeding-attack.txt", "Official AoN Bleeding Attack rogue talent, Core Rulebook p. 68"),
    ...
    *((f"source.aon-{name}-html", f"sources/reference/aonprd/{name}.html", "Archived official active-effect source page") for name in (
    ...
    ("source.aon-linguistics-language", "sources/npc/aonprd/skill-linguistics-language.txt", "Official Linguistics language-learning rule"),
    ("source.aon-fly-size", "sources/npc/aonprd/skill-fly-size.txt", "Fly skill size modifiers"),
    ("source.aon-concentration", "sources/npc/aonprd/spellcasting-concentration.txt", "Concentration uses caster level and casting ability"),
